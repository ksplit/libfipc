...
static inline
void request ( cache_line_t* cache, uint64_t index )
{
	// Write Request
...
static inline
void respond ( cache_line_t* cache, uint64_t index )
{
	// Read Request
...
int main ( void )
{
	...
	responder_thread = fipc_test_thread_spawn_on_CPU ( responder, shm_reg_p, responder_cpu );
